					...
					<div className="choose">
						...
						<div className="list">
							<input
								...
								id="v1"
								name="choose"
								onClick={() => setCalculatedValue(1000)}
							/>
							...
							<input
								...
								id="v2"
								name="choose"
								onClick={() => setCalculatedValue(2000)}
							/>
							...
							<input
								...
								id="v3"
								name="choose"
								onClick={() => setCalculatedValue(3000)}
							/>
							...
							<input
								...
								id="v4"
								name="choose"
								onClick={() => setCalculatedValue(4000)}
							/>
							...
							<input
								...
								id="v5"
								name="choose"
								onClick={() => setCalculatedValue(5000)}
							/>
							...
							<input
								...
								id="v6"
								name="choose"
								onClick={() => setCalculatedValue(6000)}
							/>
							...
							<input
								...
								id="v7"
								name="choose"
								onClick={() => setCalculatedValue(7000)}
							/>
							...
							<input
								...
								id="v8"
								name="choose"
								onClick={() => setCalculatedValue(8000)}
							/>
							...
							<input
								...
								id="v9"
								name="choose"
								onClick={() => setCalculatedValue(9000)}
							/>
							...
							<input
								...
								onClick={() =>
									setCalculatedValue(
										balanceInfo ? balanceInfo.premiumBalanceReturnable * 1000 : 0
									)
								}
							/>
							<label htmlFor="v10">
